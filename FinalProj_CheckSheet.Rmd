...
(A) .Rmd Line numbers where at least two different data sources are imported: 13, 14 


(B) .Rmd Line numbers for inspecting data intake:  15, 16, 25, 36, 53, 59
...
(A) .Rmd Line number(s) for general data wrangling: 32, 35, 36, 40, 41, 45, 46, 50-52, 56-58, 80, 83


(B) .Rmd Line number(s) for a join operation: 24


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: 41, 46


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 36
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 79-86
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  64, 65, 67

(B) .Rmd Line number(s) for use of multiple aesthetics: 64, 65 

(C) .Rmd Line number(s) for use of layered graphics:  

(D) .Rmd Line number(s) for use of leaflet maps:  

(E) .Rmd Line number(s) for use of decision tree or dendogram results:    87
